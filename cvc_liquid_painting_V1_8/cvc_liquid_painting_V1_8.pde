...
*/
  ...
  int savedTime;
  int totalTime = 15000; // time in seconds (5000=5 seconds)
...
void setup() {
    ...
    savedTime = millis();
    img[0] = loadImage("rug_1.jpg");
    img[1] = loadImage("rug_2.jpg");
    img[2] = loadImage("rug_3.jpg");
    img[3] = loadImage("rug_4.jpg");
    img[4] = loadImage("rug_5.jpg");
    img[5] = loadImage("rug_6.jpg");
    img[6] = loadImage("rug_7.jpg");
